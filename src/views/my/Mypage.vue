    ...
    <div id="my">
        ...
        <Row class="head">
            <Col span="24" class="img-col">
                <router-link to="#">
                    <img src="../../assets/headimg.jpg" class="headimg">
                </router-link>
        ...
        <Row class="my-btn">
            <router-link to="/info">
                <Col span="20" class="btn-label">
                    <p><Icon type="android-notifications"></Icon>个人信息</p>
                </Col>
        ...
        <Row class="my-btn">
            <router-link to="/message">
                <Col span="20" class="btn-label">
                    ...
                    <p><Icon type="android-notifications"></Icon>消息通知</p>
                </Col>
                <Col span="4" class="btn-icon">
                    <Icon type="ios-arrow-forward"></Icon>
                </Col>
        ...
        <Row class="my-btn">
            <router-link to="/security">
                <Col span="20" class="btn-label">
                    ...
                    <p><Icon type="android-lock"></Icon>修改密保手机</p>
                </Col>
                <Col span="4" class="btn-icon">
                    <Icon type="ios-arrow-forward"></Icon>
                </Col>
        ...
        <Row class="my-btn">
            <router-link to="/suggest">
                <Col span="20" class="btn-label">
                    ...
                    <p><Icon type="android-mail"></Icon>建议反馈</p>
                </Col>
                <Col span="4" class="btn-icon">
                    <Icon type="ios-arrow-forward"></Icon>
                </Col>
        ...
        <Row class="my-btn">
            <router-link to="/about">
                <Col span="20" class="btn-label">
                    ...
                    <p><Icon type="android-home"></Icon>关于我们</p>
                </Col>
                <Col span="4" class="btn-icon">
                    <Icon type="ios-arrow-forward"></Icon>
                </Col>
